...
class DorayaAddMembers extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isVisible: false,
    ...
    SearchAndGetObjectFromArray(arr, mobile) {
    ...
    addMember() {
        ...
        const u = this.SearchAndGetObjectFromArray(newArr, mobile)
        if (u) {
        ...
        return (
            <SafeAreaView style={styles.container} >
                ...
                <View style={[styles.column, { flex: 1, width }]} >
                    ...
                    <View style={[styles.row, { width, justifyContent: 'center', alignItems: 'center', marginTop: 16 }]} >
                        ...
                        <Text style={{ fontSize: 18, color: '#000', fontWeight: 'bold' }} >
                            {this.Language != "EN" ? 'اضافه مجموعه' : "Add Group"}
                        </Text>
                        <View style={{ borderBottomColor: '#000', borderBottomWidth: 1, height: 2, flex: 1, marginHorizontal: 18 }}></View>
                    </View>
                        ...
                        <View style={[styles.shadow, { backgroundColor: '#FFF', height: '90%', width: '90%' }]} >
                            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }} >
                                ...
                                <View style={[this.Language != "EN" ? styles.rowReverse : styles.row, { height: 80, width: '100%', borderBottomWidth: 1, borderBottomColor: '#F5F5F5', padding: 10 }]} >
                                    <View style={{ width: 60, height: 60, borderRadius: 30, backgroundColor: '#FFF', borderColor: "#00C4CA", borderWidth: 3, overflow: 'hidden' }} >
                                    ...
                                    <View style={[styles.column, this.Language != "EN" ? { alignItems: 'flex-end' } : { alignItems: 'flex-start' }, { flex: 1, justifyContent: 'space-evenly', marginHorizontal: 10 }]} >
                                        <Text style={{ color: '#00C4CA', fontSize: 18, fontWeight: 'bold' }} >{this.Language != "EN" ? "مدير المجموعة" : "Group Manager"}</Text>
                                                ...
                                                return (
                                                    <View key={index.toString()} style={[this.Language != "EN" ? styles.row : styles.rowReverse, { width: "100%", backgroundColor: '#FFF', justifyContent: 'center', alignItems: 'center', paddingHorizontal: 12, marginBottom: 4 }]} >
                                                        <TouchableOpacity onPress={() => this.deleteMember(index)} >
                                                            <FontAwesome name={'trash-o'} style={{ fontSize: 16, color: '#00c4ca', marginHorizontal: 8 }} />
                                                        </TouchableOpacity>
                ...
                <View style={{ width, height: 60 }} >
                    <View style={[this.Language != "EN" ? styles.rowReverse : styles.row, { flex: 1, justifyContent: 'flex-start', alignItems: 'center', paddingHorizontal: 36 }]} >
                        <View style={[this.Language != "EN" ? styles.rowReverse : styles.row, { justifyContent: 'space-evenly', alignItems: 'center' }]} >
                            ...
                            <Text style={{ marginHorizontal: 8 }} >{this.Language != "EN" ? "اضافه عضو جديد" : "Add member"} </Text>
                        </View>
                        <View></View>
                    </View>
                </View>
                ...
                <View style={{ width, height: 80, backgroundColor: '#00C4CA', borderTopLeftRadius: 38, borderTopRightRadius: 38 }} >
                    <View style={[styles.row, { flex: 1, justifyContent: 'center', alignItems: 'center' }]} >
                        <TouchableOpacity onPress={() => this.save()} style={[styles.row, { width: width * 0.5, justifyContent: 'center', backgroundColor: '#FFF', paddingVertical: 8, borderRadius: 16, borderColor: '#00A5AA', borderWidth: 1, paddingHorizontal: 12 }]}>
                            <Text style={{ color: '#000', textAlign: 'center', fontSize: 12 }} >{this.Language != "EN" ? "اضف المجموعة" : "Add Group"}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
...
// redux
export default connect(mapStateToProps, {})(DorayaAddMembers)
