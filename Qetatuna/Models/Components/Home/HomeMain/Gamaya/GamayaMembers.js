...
class GamayaMembers extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleBackButtonClick = () => {
        ...
        this.props.navigation.navigate('GamayaAdd', { Gamaya: Gamaya });
        return true;
    }
    ...
    addMember() {
        ...
        */
        ...
        if (u) {
            ...
            if (parseInt(this.state.membersNum) > this.state.members.length) {
            ...
            <SafeAreaView style={styles.container} >
                ...
                <View style={[styles.column, { flex: 1, width }]} >
                    ...
                    <View style={[styles.row, { width, justifyContent: 'center', alignItems: 'center', marginVertical: 16 }]} >
                        ...
                        <Text style={{ fontSize: 18, color: '#E1D115', fontWeight: 'bold' }} >
                    ...
                    <View style={[styles.row, { width, flex: 1, justifyContent: 'center', alignItems: 'center' }]} >
                        <View style={[styles.shadow, { backgroundColor: '#FFF', height: '100%', width: '90%' }]} >
                            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1, paddingBottom: 70 }} >
                                ...
                                <View style={[styles.column, { flex: 1, marginVertical: 4, alignItems: 'flex-start' }]}>
                                                ...
                                                return (
                                                    ...
                                                    <View key={index.toString()} style={[this.Language != "EN" ? styles.row : styles.rowReverse, { width: "100%", backgroundColor: '#FFF', justifyContent: 'center', alignItems: 'center', paddingHorizontal: 12, marginBottom: 4 }]} >
                                                        <TouchableOpacity onPress={() => this.deleteMember(index)} >
                                                            <FontAwesome name={'trash-o'} style={{ fontSize: 16, color: '#e1d115', marginHorizontal: 8 }} />
                                                        </TouchableOpacity>
                ...
                <View style={{ width, height: 80, backgroundColor: '#E1D115', borderTopLeftRadius: 38, borderTopRightRadius: 38 }} >
                    <View style={[styles.row, { flex: 1, justifyContent: 'center', alignItems: 'center' }]} >
                        <TouchableOpacity onPress={() => this.save()} style={[styles.row, { width: width * 0.5, justifyContent: 'center', backgroundColor: '#FFF', paddingVertical: 8, borderRadius: 16, borderColor: '#CBBE21', borderWidth: 1, paddingHorizontal: 12 }]}>
                            <Text style={{ color: '#000', textAlign: 'center', fontSize: 12, fontWeight: "bold" }} >{this.Language != "EN" ? "أضف المجموعة" : "Add Gamaya"}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
...
// redux
export default connect(mapStateToProps, {})(GamayaMembers)
