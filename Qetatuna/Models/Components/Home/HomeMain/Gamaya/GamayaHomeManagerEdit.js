...
class GamayaHomeManagerEdit extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            members: this.props.navigation.getParam('Gamaya') ? this.props.navigation.getParam('Gamaya').membersEdited : [],
            membersEdit: [],
            Processing: false,
            // memberData: null,
            hoverData: {},
    ...
    save() {
        ...
        const { _id, group, aljameiaType, aljameiaAmount, membersNum, startDate, alarm, createBy, members, membersEdit } = this.state
        ...
        try {
            ...
            axios.put('http://167.172.183.142/api/user/editAljameia/' + _id, {
    ...
    handleBackButtonClick = () => {
        ...
        const Gamaya = { _id, group, aljameiaType, aljameiaAmount, membersNum, startDate, alarm, createBy, members }
        this.props.navigation.navigate('GamayaEditMembers', { Gamaya: Gamaya });
        return true;
    }
...
// redux
export default connect(mapStateToProps, {})(GamayaHomeManagerEdit)
